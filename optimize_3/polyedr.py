...
class Edge:
    ...
    def shadow(self, facet):
        # "Вертикальная" грань не затеняет ничкго
    ...
    # Пересечение ребра с полупространством, задаваемым точкой (а)
...
class Polyedr:
    ...
    # Параметры конструктораЖ файлб задающий полиэдр

    def __init__(self, file):

        # списки вершинб рёбер и граней полиэдра
